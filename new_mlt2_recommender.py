...
Adapun untuk buku yang ingin dicari rekomendasinya, **The Road to Dune** ditulis oleh Frank Herbert, Brian Herbert, dan Kevin J. Anderson. Memiliki skor rating 3,88 dan berbahasa Inggris. Dari kategori bahasa, presisi yang didapatkan adalah (10/10) =  1, atau 100% Presisi, dikarenakan sistem merekomendasikan seluruh buku berbahasa yang sama

Untuk Author, Sistem Rekomendasi juga memberikan rekomendasi karya yang ditulis oleh penulis **The Road to Dune**, namun dengan presisi sedikit berkurang karena adanya rekomendasi buku oleh Doug Stanton. Sehingga, presisi rekomendasiadalah (9/10) = 0.9, atau 90% Presisi.
"""
